...
import getPaymentInfo from '@salesforce/apex/AdyenB2BPaymentController.getPaymentInfo';
import authorizePaymentInfo from '@salesforce/apex/AdyenB2BPaymentController.authorizePaymentInfo';
 ...
 * @fires AdyenPaymentMethod#submitpayment
 */
export default class AdyenPaymentMethod extends LightningElement {
    // Private attributes
    _addresses;
    ...
    handlePaymentButton() {
        ...
        if (
            ...
            authorizePaymentInfo({
                cartId: this.cartId,
                selectedBillingAddress: selectedAddressResult.address,
            ...
            if (selectedAddressResult.error) {
                this._creditCardErrorMessage = selectedAddressResult.error.message;
                return;
            }
